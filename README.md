...
- Follow the [thoughtbot code review guidelines](https://github.com/thoughtbot/guides/tree/fa8691f4813325cbd927d055803b335be448a8c1/code-review)
...
#### 📐 Clean Code, Clean UI, and Clean Products

I'm a stickler for nice abstractions, [using the platform](https://developer.apple.com/design/human-interface-guidelines/) and delightful, [lickable](https://www.zdnet.com/article/lickable-buttons/) apps.
...
Sometimes, I enjoy a little [boyscouting](https://deviq.com/principles/boy-scout-rule) or [KonMari](https://dev.to/kaydacode/tidying-up-your-code-konmari-style-3b64) in a codebase.

## ⚠️ Warnings

#### Meetings with no agendas

[One of the most effective ways to run a meeting is to set an agenda](https://www.lifelabslearning.com/workshops/meetings-mastery). Joining a meeting with no agenda might leave me frustrated or unengaged.
...
I quite enjoy and am motivated by public praise. I'm a sucker for a :heart: reaction on a comment or pull request.
...
If I'm out-of-office, chances are I'm not going to see or reply to your message. I often use out-of-office time to step away from software (see also: [my contribution graph on weekends](https://github.com/eliperkins)) and spend time letting my brain think about other problems.
